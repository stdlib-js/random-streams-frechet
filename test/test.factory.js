...
tape( 'the function returns a factory function (parameters)', function test( t ) {
	var createStream = factory( 2.0, 5.0, 3.0 );
	t.strictEqual( typeof createStream, 'function', 'returns expected value' );
	t.end();
});
...
tape( 'the function returns a function which throws an error if shape `alpha` is not a positive number primitive', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( value, 2.0, 0.0 );
		};
	}
});

tape( 'the function returns a function which throws an error if shape `alpha` is not a positive number primitive (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( value, 2.0, 3.0 );
			createStream();
		};
	}
});

tape( 'the function returns a function which throws an error if scale `s` is not a positive number primitive', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( 2.0, value, 1.0 );
		};
	}
});

tape( 'the function returns a function which throws an error if scale `s` is not a positive number primitive (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2.0, value, 0.0 );
			createStream();
		};
	}
});

tape( 'the function returns a function which throws an error if location `m` is not a number primitive', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( 2.0, 1.0, value );
		};
	}
});

tape( 'the function returns a function which throws an error if location `m` is not a number primitive (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2.0, 1.0, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an options argument which is not an object (parameters)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2.0, 5.0, 3.0, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 2.0, 5.0, 3.0 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
...
tape( 'the function returns a factory function which creates stream instances (parameters)', function test( t ) {
	...
	createStream = factory( 2.0, 5.0, 3.0 );
