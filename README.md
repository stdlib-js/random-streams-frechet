...
```bash
npm install @stdlib/random-streams-frechet
```
...
```bash
npm install -g @stdlib/random-streams-frechet
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-frechet
